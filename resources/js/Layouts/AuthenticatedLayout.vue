<template>
    <div class="flex h-screen bg-gray-100">
      <!-- Sidebar -->
      <aside :class="{'block': !isMobile || showMobileMenu, 'hidden': isMobile && !showMobileMenu}" class="w-64 bg-gray-800 text-white flex-shrink-0 md:flex md:flex-col md:h-screen">
      ...
      <!-- Main Content -->
      <main :class="{'': !isMobile && !showMobileMenu, 'flex-1 p-4': isMobile}" class="flex-1 p-6">
