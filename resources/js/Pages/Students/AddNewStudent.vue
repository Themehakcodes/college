<template>
    <div class="p-6 bg-gray-100">
      <div class="w-full p-8 mx-auto bg-white rounded-lg shadow-lg">
        <h2 class="mb-8 text-2xl font-bold">Add New Student</h2>
  
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
          <!-- Profile Information -->
          <div>
            <h3 class="mb-4 text-lg font-semibold">1. Profile Information</h3>
          ...
          <div>
            ...
            <input v-model="contact.mobile1" type="tel" placeholder="Mobile No." class="block w-full p-2 mb-4 border rounded-md" />
            <input v-model="contact.mobile2" type="tel" placeholder="Mobile No. 2" class="block w-full p-2 mb-4 border rounded-md" />
            <input v-model="contact.city" type="text" placeholder="City" class="block w-full p-2 mb-4 border rounded-md" />
            <input v-model="contact.address" type="text" placeholder="Address" class="block w-full p-2 mb-4 border rounded-md" />
          </div>
        </div>
        ...
        <h3 class="mb-4 text-lg font-semibold">4. Academic Information</h3>
        <div class="grid grid-cols-1 gap-6 mb-6 md:grid-cols-2">
        ...
        <!-- Documents Upload -->
        <h3 class="mb-4 text-lg font-semibold">5. Documents Upload</h3>
        <div class="grid grid-cols-1 gap-6 mb-6 md:grid-cols-2">
          <input type="file" class="block w-full p-2 mb-4 border rounded-md" placeholder="10th Class Documents" />
          <input type="file" class="block w-full p-2 mb-4 border rounded-md" placeholder="12th Class Documents" />
          <input type="file" class="block w-full p-2 mb-4 border rounded-md" placeholder="Character Certificate (Last Institute)" />
          <input type="file" class="block w-full p-2 mb-4 border rounded-md" placeholder="Diploma Certificate" />
          <input type="file" class="block w-full p-2 mb-4 border rounded-md" placeholder="Character Certificate (From Diploma)" />
          <input type="file" class="block w-full p-2 mb-4 border rounded-md" placeholder="Aadhar Card Upload" />
          <input type="file" class="block w-full p-2 mb-4 border rounded-md" placeholder="Parent's Aadhar Card Upload" />
          <input type="file" class="block w-full p-2 mb-4 border rounded-md" placeholder="Last Semester Document Upload" />
          <input type="file" class="block w-full p-2 mb-4 border rounded-md" placeholder="Blood Group Report Upload" />
          <input type="file" class="block w-full p-2 mb-4 border rounded-md" placeholder="Bank Passbook Upload" />
          <input type="file" class="block w-full p-2 mb-4 border rounded-md" placeholder="Income Certificate Upload" />
          <input type="file" class="block w-full p-2 mb-4 border rounded-md" placeholder="Caste Certificate Upload" />
        </div>
  
        <button @click="submitForm" class="px-6 py-2 text-white bg-green-500 rounded-md">Submit</button>
      </div>
    </div>
  </template>
